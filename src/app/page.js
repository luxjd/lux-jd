...
export default function Home() {
  return (
    <>
      {/* Top Navigation Bar */}
      <nav className="fixed top-0 w-full z-50 bg-[#0B0B0B]/80 backdrop-blur-xl shadow-[0_0_20px_rgba(58,134,255,0.1)] flex justify-between items-center px-8 py-4 max-w-full font-headline tracking-tighter uppercase">
        <div className="text-xl font-bold tracking-widest text-slate-100">
          LUXURY AUTO ARBITRAGE
        </div>
        ...
        <button className="bg-primary-container text-on-primary-container px-6 py-2 rounded-xl font-bold scale-95 active:scale-90 transition-transform hover:shadow-[0_0_15px_rgba(173,198,255,0.4)]">
          Explore Inventory
        </button>
      </nav>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl px-6">
          <div className="inline-block mb-4 px-4 py-1 rounded-full border border-primary/20 bg-primary/10 backdrop-blur-md">
            <span className="text-primary font-medium tracking-widest uppercase text-xs">
              The Pinnacle of Sourcing
            </span>
          </div>
          <h1 className="font-headline text-5xl md:text-8xl font-bold mb-6 neon-text-glow leading-tight">
            AI-Powered{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
              Luxury Car Arbitrage
            </span>
          </h1>
          <p className="text-on-surface-variant text-xl md:text-2xl mb-10 max-w-2xl mx-auto leading-relaxed">
            Source undervalued supercars from Japan. Sell at premium in Europe.
            Guided by hyper-intelligent market data.
          </p>
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <button className="px-10 py-4 bg-primary text-on-primary font-bold rounded-xl text-lg hover:shadow-[0_0_25px_rgba(173,198,255,0.5)] transition-all duration-300">
              Explore Inventory
            </button>
            <button className="px-10 py-4 border-2 border-outline/30 text-on-surface font-bold rounded-xl text-lg backdrop-blur-sm hover:border-primary/50 transition-all">
              View Strategy
            </button>
          </div>
        </div>
      ...
      <div className="relative z-20 -mt-12 max-w-7xl mx-auto px-6">
        <div className="glass-panel rounded-full py-8 px-12 grid grid-cols-1 md:grid-cols-3 gap-8 items-center border border-outline-variant/15">
          <div className="flex items-center gap-4 justify-center md:border-r border-outline-variant/30">
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-4 gap-12">
            {/* Connector Line */}
            <div className="hidden md:block absolute top-12 left-0 w-full h-[2px] bg-gradient-to-r from-primary/0 via-primary/50 to-secondary/0 z-0"></div>

            {/* Step 1 */}
            <div className="relative z-10 group">
              <div className="w-24 h-24 rounded-full bg-surface-container-high border border-primary/30 flex items-center justify-center mb-8 mx-auto group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(173,198,255,0.3)] transition-all">
            ...
            {/* Step 2 */}
            <div className="relative z-10 group">
              <div className="w-24 h-24 rounded-full bg-surface-container-high border border-secondary/30 flex items-center justify-center mb-8 mx-auto group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(234,193,105,0.3)] transition-all">
      ...
      <section className="py-24 bg-surface-container-low px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="group bg-surface-container rounded-2xl overflow-hidden border border-outline-variant/10 hover:border-primary/50 transition-all duration-500 scale-100 hover:scale-[1.02]">
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div className="p-8 glass-panel border border-outline-variant/10 rounded-2xl flex flex-col items-center text-center hover:border-primary/40 transition-all cursor-default">
            ...
            <div className="p-8 glass-panel border border-outline-variant/10 rounded-2xl flex flex-col items-center text-center hover:border-primary/40 transition-all cursor-default md:mt-12">
      ...
      {/* Premium CTA */}
      <section className="py-32 px-6">
        <div className="max-w-6xl mx-auto relative rounded-[3rem] overflow-hidden bg-gradient-to-br from-[#0B0B0B] via-[#0B0B0B] to-primary/20 p-20 border border-primary/10">
          <div className="absolute inset-0 z-0">
            <Image
          ...
          <div className="relative z-10 text-center">
            ...
            <button className="bg-secondary text-on-secondary font-headline font-extrabold text-xl px-12 py-6 rounded-xl hover:shadow-[0_0_30px_rgba(234,193,105,0.6)] transition-all duration-500 scale-100 hover:scale-105 active:scale-95 uppercase tracking-widest">
              Get Started
            </button>
          </div>
        </div>
      ...
      <footer className="w-full border-t border-[#EAC169]/30 bg-[#121212] flex flex-col md:flex-row justify-between items-center px-12 py-8 gap-6 font-body text-sm tracking-wide">
        <div className="text-slate-500">© 2024 LUXURY AUTO ARBITRAGE</div>
